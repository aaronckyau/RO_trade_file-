...
- Keep stock tickers, company names, broker names, deal numbers, and market terms in English where clearer.
...
- Technical setup on the actual trade date
...
Technical analysis must use market data available on the actual trade date.

Do not use current price, current moving averages, or post-trade technical data when explaining the original trade decision.

For each report, include the most relevant actual trade-date data where available:
...
- ATR14
- 20-day high / low
- 52-week high / low as of the trade date
