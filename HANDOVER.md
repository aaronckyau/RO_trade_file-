...
- Current application version: `v2026.08.07.1`. The version is displayed beside the Settings button in the top band. Production remains on the previous version until this change is explicitly deployed.
